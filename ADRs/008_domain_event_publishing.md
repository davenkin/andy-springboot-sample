...
- For every domain event class, you need to register it inside [DomainEvent](../src/main/java/com/company/andy/common/event/DomainEvent.java). This is for Jackson to work properly even without the type information(`__TypeId__`) in Kafka message headers.
```java
